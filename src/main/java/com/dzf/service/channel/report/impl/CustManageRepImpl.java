...
public class CustManageRepImpl implements ICustManageRep {
	...
	public HashMap<String, CustManageRepVO> queryCorps(QryParamVO paramvo, List<String> corplist)
			throws DZFWarpException {
	...
	private List<CustManageRepVO> qryCharge(QryParamVO paramvo, Boolean flg) {
		...
		List<CustManageRepVO> list = (List<CustManageRepVO>) singleObjectBO.executeQuery(sql.toString(), sp,
				new BeanListProcessor(CustManageRepVO.class));
		return list;
	}
	...
	private List<CustManageRepVO> qryNotCharge(QryParamVO paramvo, Boolean flg, List<String> vprovinces) {
		...
		List<CustManageRepVO> vos = (List<CustManageRepVO>) singleObjectBO.executeQuery(sql.toString(), sp,
				new BeanListProcessor(CustManageRepVO.class));
		return vos;
	}
