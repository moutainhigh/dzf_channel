...
import com.dzf.pub.lang.DZFTime;
...
//						? IPiaoTongConstant.errorMap.get(resvo.getCode()) : resvo.getMsg()
//				);
			return resvo;
		}
		...
		System.out.println("222222===="+contentvo.getInvoiceReqSerialNo());
		System.out.println("222222===="+contentvo.getQrCode());
		System.out.println("222222===="+contentvo.getQrCodePath());
		return resvo;
//		return contentvo;
	}
    ...
    private Map<String, String> getBusiParams(PiaoTongInvVO hvo) throws Exception {
        ...
        System.out.println("11111===="+hvo.getInvoiceReqSerialNo());
