...
@Namespace("/report")
@Action(value = "regionalman")
public class RegionalManAction extends BaseAction<ManagerVO>{

	@Autowired
	private IRegionalManService regional;
	...
	public void query() {
		...
		try {
			...
			List<ManagerVO> vos = regional.query(qvo);
