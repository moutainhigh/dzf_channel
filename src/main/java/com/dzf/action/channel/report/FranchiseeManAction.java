...
@Namespace("/report")
@Action(value = "franchiseeman")
public class FranchiseeManAction extends BaseAction<ManagerVO>{

	@Autowired
	private IFranchiseeManService franchisee;
	...
	public void query() {
		...
		try {
			...
			List<ManagerVO> vos = franchisee.query(qvo);
