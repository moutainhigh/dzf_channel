...
@Namespace("/branch")
@Action(value = "companyData")
public class CompanyDataAction extends PrintUtil<CompanyDataVO> {

	private Logger log = Logger.getLogger(this.getClass());
	
	@Autowired
	private ICompanyDataService company;
	...
	public void query() {
		...
		try {
			...
			List<CompanyDataVO> list = company.query(qvo);
	...
	public void exportExcel(){
		...
		try {
			...
			byte[] length = ex.exportCompanyDataExcel("公司数据统计", heads, heads1, fieldslist, exparray, toClient, "", fieldlist,
					num);
