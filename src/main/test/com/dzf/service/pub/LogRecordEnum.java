...
public enum LogRecordEnum {
	 ...
	 * 管理平台
	 */
	OPE_ADMIN_SYS(17, "系统"),OPE_ADMIN_WDKH(18, "我的客户"),OPE_ADMIN_QZKHGL(19, "潜在客户管理"),OPE_ADMIN_KHQY(20, "客户签约"),
	...
	OPE_ADMIN_JZTZ(29, "建账调整"),OPE_ADMIN_KHFC(30, "客户封存"),OPE_ADMIN_JDRXX(31, "接单人信息"),OPE_ADMIN_FWXMXX(32, "服务项目信息"),
	OPE_ADMIN_FWXMFB(33, "服务项目发布"),OPE_ADMIN_DDCX(34, "订单查询"),OPE_ADMIN_JDGL(35, "进度管理"),OPE_ADMIN_QFXX(36, "群发消息"),
	OPE_ADMIN_QFYJ(37, "群发邮件"),OPE_ADMIN_NSGZT(38, "纳税工作台"),OPE_ADMIN_JZGZT(39, "记账工作台"),OPE_ADMIN_QFTJ(40, "欠费统计"),
	OPE_ADMIN_SFSH(41, "收费审核"),OPE_ADMIN_SFDJ(42, "收费登记"),OPE_ADMIN_DSDJ(43, "代收代缴"),OPE_ADMIN_YWCL(44, "业务处理"),
	OPE_ADMIN_YWCX(45, "业务查询"),OPE_ADMIN_DLJZHT(46, "代理记账合同"),OPE_ADMIN_ZZFWHT(47, "增值服务合同"),OPE_ADMIN_HTSH(48, "合同审核"),
	...
	OPE_ADMIN_YWXL(57, "业务小类"),OPE_ADMIN_YWBLNR(58, "办理业务内容"),OPE_ADMIN_YWLCSZ(59, "业务流程设置"),OPE_ADMIN_DJBHWH(60, "单据编号维护"),
	OPE_ADMIN_DXTXSZ(61, "短信提醒设置"),OPE_ADMIN_ZLDA(62, "资料档案"),OPE_ADMIN_GZJQSZ(63, "工作机器设置"),OPE_ADMIN_YWSQ(64, "业务申请"),
	OPE_ADMIN_JSGL(65, "角色管理"),OPE_ADMIN_JSQX(66, "角色权限"),OPE_ADMIN_YHGL(67, "用户管理"),OPE_ADMIN_KJRYQXFP(68, "会计公司权限分配"),
	OPE_ADMIN_GSRYQXCK(69, "公司人员权限查看"),OPE_ADMIN_GLBB(70, "管理报表"),OPE_ADMIN_YSTX(78, "应收提醒"),OPE_ADMIN_DQHT(79, "到期合同"),
    ...
    OPE_CHANNEL_8(117,"财务处理分析"),OPE_CHANNEL_42(118,"商品管理"),OPE_CHANNEL_43(119,"加盟商订单");
	...
	public static LogRecordEnum[] getAdminSysEnum() {
		return new LogRecordEnum[] {OPE_ALL_SYS,OPE_ADMIN_SYS,OPE_ADMIN_WDKH,OPE_ADMIN_QZKHGL,OPE_ADMIN_KHQY,
				OPE_ADMIN_KHLY,OPE_ADMIN_KHPJ,OPE_ADMIN_XYWHZ,OPE_ADMIN_CYZY,
				OPE_ADMIN_ZLJJ,OPE_ADMIN_ZTZY,OPE_ADMIN_KHDR,OPE_ADMIN_PLJZ,
				OPE_ADMIN_JZTZ,OPE_ADMIN_KHFC,OPE_ADMIN_JDRXX,OPE_ADMIN_FWXMXX,
				OPE_ADMIN_FWXMFB,OPE_ADMIN_DDCX,OPE_ADMIN_JDGL,OPE_ADMIN_QFXX,
				OPE_ADMIN_QFYJ,OPE_ADMIN_NSGZT,OPE_ADMIN_JZGZT,OPE_ADMIN_QFTJ,
				OPE_ADMIN_SFSH,OPE_ADMIN_SFDJ,OPE_ADMIN_DSDJ,OPE_ADMIN_YWCL,
				OPE_ADMIN_YWCX,OPE_ADMIN_DLJZHT,OPE_ADMIN_ZZFWHT,OPE_ADMIN_HTSH,
				OPE_ADMIN_HTCX,OPE_ADMIN_YXSZ,OPE_ADMIN_BMDA,OPE_ADMIN_FYLX,
				OPE_ADMIN_CSSZ,OPE_ADMIN_KJGS,OPE_ADMIN_FZJG,OPE_ADMIN_YWDL,
				OPE_ADMIN_YWXL,OPE_ADMIN_YWBLNR,OPE_ADMIN_YWLCSZ,OPE_ADMIN_DJBHWH,
				OPE_ADMIN_DXTXSZ,OPE_ADMIN_ZLDA,OPE_ADMIN_GZJQSZ,OPE_ADMIN_YWSQ,
				OPE_ADMIN_JSGL,OPE_ADMIN_JSQX,OPE_ADMIN_YHGL,OPE_ADMIN_KJRYQXFP,
				OPE_ADMIN_GSRYQXCK,OPE_ADMIN_GLBB,OPE_ADMIN_YSTX,OPE_ADMIN_DQHT};
	}
	...
	public static LogRecordEnum[] getChnSysEnum() {
        return new LogRecordEnum[] {OPE_CHANNEL_SYS,OPE_CHANNEL_XSGZSZ,OPE_CHANNEL_FPGL,OPE_CHANNEL_HYFX,OPE_CHANNEL_YHGL,OPE_CHANNEL_QDQYHF,
                ...
                OPE_CHANNEL_6,OPE_CHANNEL_7,OPE_CHANNEL_8,OPE_CHANNEL_42,OPE_CHANNEL_43};
    }
