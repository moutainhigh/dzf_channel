...
$(function(){
	...
	grid = $('#khTable').datagrid({
	    url: DZF.contextPath + '/chn_set/account!queryCorpk.action',
	    queryParams :params,
	    method: 'post',
		fitColumns: true,
		idField:'corpkid',
		...
		pagination : true,
		striped:true,
	    columns:[[  { title : '主键id', field : 'corpkid', hidden : true }, 
					{ width : '100', title : '客户编码', field : 'incode' }, 
					{ width : '100', title : '客户名称', field : 'corpkname' }
	   	 ]],
