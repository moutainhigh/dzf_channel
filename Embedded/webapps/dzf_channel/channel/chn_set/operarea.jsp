...
<script src=<%UpdateGradeVersion.outversion(out,"../../js/channel/chn_set/operarea.js");%> charset="UTF-8" type="text/javascript"></script>
	...
	<div id="cardDialog">
		<form id="chnarea" method="post" style="height:360px;width:1000px;overflow:hidden;padding-top:18px;">
			...
			<div class="time_col time_colp11">
				...
				<div  style="width:32%;display: inline-block;" >
					<label style="text-align:right;width:35%;">运营负责人：</label> 
