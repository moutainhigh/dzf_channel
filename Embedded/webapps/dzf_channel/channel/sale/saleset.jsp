...
<script src=<%UpdateGradeVersion.outversion(out,"../../js/channel/sale/saleset.js");%> charset="UTF-8" type="text/javascript"></script>
...
<body class="easyui-layout">
	<div class="wrapper">
		...
		<div class="mod-inner" style="width:99%;height:82%">
			<form id="sale_set" method="post">
				...
				<span class="checkbox">
					<label>回收规则：</label>
					<input name="isfirecovery" type="checkbox" id='isfirecovery' value="是"/>
					<label for="isfirecovery">领取后</label>
					<input class="easyui-numberbox" id ="finum" name="finum" style="width:50px"> 
					<label>自然日未拜访，自动回收客户 </label>
				</span><br/>
				<div style="margin:6px 0px 10px 94px;font-size:14px;color:#000">
				...
				<span class="checkbox">
					<label for="pwdstrategy">领取上限: </label>
				...
				<span class="checkbox">
					<label for="pwdstrategy">延期规则: </label>
				...
				<div style="width:25%;display: inline-block;">
					<label style="text-align:right;width:35%;">最后修改人：</label> 
