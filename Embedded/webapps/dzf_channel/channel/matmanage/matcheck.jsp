...
<body>
	...
	<div id="listPanel" class="wrapper" style="width: 100%;overflow:hidden; height: 100%;">
		...
		<!-- 新增对话框  begin-->
		<div id="cbDialog" class="easyui-dialog" style="height:540px;width:680px;overflow:hidden;padding-top:18px;" 
			...
			<form id="mat_add" method="post">
				...
				<div class="time_col time_colp10">
				     <span class="hid">
				     <label style="width:124px;text-align:right;margin-top: -37px;"><i class="bisu">*</i>驳回原因：</label>
				     <textarea id="reason" class="easyui-textbox" name="reason" style="width: 431px;height:51px;"></textarea>
				     </span>
				</div>
