			...
			<div class="mod-toolbar-content">
				...
				<div class="left mod-crumb">
					<div style="margin:6px 0px 0px 10px;float:right;font-size:14px;">
						<a href="javascript:void(0)"  style="font-size:14;color:blue;" onclick="loadData(1)">待审批</a>
						<a href="javascript:void(0)"  style="font-size:14;color:blue;margin-left:15px; " onclick="loadData(2)">已驳回</a>
					</div>
				</div>
				<div class="right">
		...
		<div id="cbDialog" class="easyui-dialog" style="height:550px;width:680px;overflow:hidden;padding-top:18px;" 
			...
			<form id="mat_add" method="post">
			    ...
			    <div class="time_col time_colp10">
						...
						<input id="corpnm" class="easyui-textbox" style="width:286px;height:28px;"/>
						<input id="fcorp" name="fcorp" >
				</div>
				<div class="time_col time_colp10">
						<label style="width:85px;text-align:right"><i class="bisu">*</i>所在地区：</label> 
				...
				<div class="time_col time_colp10">
				       <label style="width:85px;text-align:right;margin-top: -126px;"><i class="bisu">*</i>详细地址：</label> 
				       <textarea id="address" name="address" style="width: 432px;" rows="4"></textarea>
				</div>
				<div class="time_col time_colp10">
				...
				<div class="time_col time_colp10">
               	...
               	<div class="time_col time_colp10">
						<label style="width:85px;text-align:right;margin-top: -126px;">备注：</label>
						<textarea id="memo" name="memo" style="width: 432px;" rows="4" placeholder="最多可输入 200 个字"></textarea>
				</div>
				<div class="time_col time_colp10">
					   <label style="width:85px;text-align:right">申请人：</label> 
					   <input id="applyname" name="applyname" class="easyui-textbox" style="width:166px;height:28px;"/>
					   <label style="width:85px;text-align:right">申请时间：</label> 
					   <input id="adate" name="adate" type="text" class="easyui-datebox" 
						 data-options="width:166,height:27" />  
				</div>
				<div style="float:right;margin-top:12px;margin-right:276px;">
