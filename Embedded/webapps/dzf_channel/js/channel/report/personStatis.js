...
function load(){
	...
	$('#grid').datagrid({
		...
		columns : [[	{ field : 'pid',    title : '会计公司主键', hidden : true,rowspan:2},
		                ...
		                { field : 'jms01',  title : '机构负责人', width : 70,halign:'center',align:'center',rowspan:2},
		                { field : 'meiyong1',  title : '会计团队总人数', width : 160,halign:'center',align:'left',colspan:7},
		                { field : 'ktotal',  title : '人员占比(%)', width : 80,halign:'center',align:'center',rowspan:2,formatter:formatMny},
		                { field : 'meiyong2',  title : '销售团队总人数', width : 160,halign:'center',align:'left',colspan:3},
		                { field : 'xtotal',  title : '人员占比(%)', width : 80,halign:'center',align:'center',rowspan:2,formatter:formatMny},
		                { field : 'total',  title : '总用户数', width : 60,halign:'center',align:'center',rowspan:2},
	                ],[
	                   	{ field : 'jms02', title : '会计经理', width : 60,align:'center' },
	                   	{ field : 'jms06', title : '会计主管', width : 60,align:'center' },
	                   	{ field : 'jms07', title : '主办会计', width : 60,align:'center' },
	                   	{ field : 'jms08', title : '记账会计', width : 60,align:'center' },
	                   	{ field : 'jms09', title : '财税支持', width : 60,align:'center' },
	                   	{ field : 'jms05', title : '外勤主管', width : 60,align:'center' },
	                   	{ field : 'jms11', title : '外勤会计', width : 60,align:'center' },
	                   	
	                   	{ field : 'jms03', title : '销售经理', width : 60,align:'center' },
