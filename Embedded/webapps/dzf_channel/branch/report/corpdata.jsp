...
<script src=<%UpdateGradeVersion.outversion(out,"../../js/branch/report/corpdata.js");%> charset="UTF-8" type="text/javascript"></script>
	...
	<div id="List_panel" class="wrapper" data-options="closed:false">
		...
		<div class="qijian_box" id="qrydialog" style="display:none; width:450px; height:270px">
			<s class="s" style="left: 25px;"><i class="i"></i> </s>
				...
				<div class="time_col time_colp10">
					<label style="text-align:right;width:70px;">公司名称：</label> 
					<input id="cpname"  name="cpname" class="easyui-combobox" style="width:284px; height: 28px;" 
						data-options="valueField:'id',textField:'name',panelHeight:150" editable="false" />  
				</div>
				<div class="time_col time_colp10">
					<label style="width:70px;text-align:right">客户编码：</label>
					<input id="cpkcode" class="easyui-textbox" style="width:284px;height:28px;"/>
				</div>
				<div class="time_col time_colp10">
					<label style="width:70px;text-align:right">客户名称：</label>
					<input id="cpkname" class="easyui-textbox" style="width:284px;height:28px;"/>
				</div>
				<div class="time_col time_colp10">
					<label style="width:70px;text-align:right">销售人员：</label>
					<input id="saler" class="easyui-textbox" style="width:102px;height:28px;" />
