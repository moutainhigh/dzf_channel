...
<script src=<%UpdateGradeVersion.outversion(out, "../../js/branch/report/salerdata.js");%> charset="UTF-8" type="text/javascript"></script>
...
<body>
	<div id="List_panel" class="wrapper" data-options="closed:false">
		...
		<!-- 查询对话框 begin -->
		<div class="qijian_box" id="qrydialog" style="display:none; width:450px; height:180px">
			...
			<div class="time_col time_colp10">
				<label style="width:85px;text-align:right">销售人员：</label>
