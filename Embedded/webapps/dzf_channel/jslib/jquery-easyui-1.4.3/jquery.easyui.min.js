...
////判断浏览器版本，若为ie9以下，则使searchbox的按钮z-index长度为99,即不被searchbox的输入框覆盖
//var browser=navigator.appName;
//var b_version=navigator.appVersion;
//var version=b_version.split(";");
//var trim_Version=version[1].replace(/[ ]/g,""); 
//if(browser=="Microsoft Internet Explorer" && (trim_Version=="MSIE6.0" ||
//		 trim_Version=="MSIE7.0" || trim_Version=="MSIE8.0" || trim_Version=="MSIE9.0")){
//	//$(".textbox-addon").css("z-index","1");
//}
...
var icon=$(this);
if(icon.context.className=='textbox-icon foxdate'){
icon.removeClass("textbox-icon-disabled");
}
else if(!conf||conf.disabled||opts.disabled||opts.readonly){
...
function _68e(a,r){
for(var i=0;i<a.length;i++){
if(a[i] && a[i][opts.idField]==r[opts.idField]){
a[i]=r;
return true;
}
}
